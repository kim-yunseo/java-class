...
//        }
        ...
        for (char ch : arr) { //향상된 for문
         ...
         System.out.println(arr[4]); //배열은 0번부터 시작
       ...
       if (str.length() >= 3) {
        ...
        String tr2 = tr1.trim();
        System.out.println("공백 제거: [" + tr2 + "]"); //[Hello        Java]


        // 9. split() : 문자열 분리, 구분자를 기준으로 잘라 배열에 저장
        System.out.println("\n=== 9. split() ===");
        String test = "Java,Python,C";
        String[] sarr = test.split(","); //,를 기준으로 분리

        for (String s : sarr) {
            System.out.println(s); //[0] java [1] Python [2] c
        }
       ...
       System.out.println("\n=== 10. 문자열 비교 ===");
        ...
        System.out.println("concat 결과: " + result); //Hello World
